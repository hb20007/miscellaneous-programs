 ...
 */
extern char const *deduceCharsetSizeAndAdvice(const int passLength,
                                              const int passType,
                                              int *charsetSizePtr);
 ...
 * @param passLength The password length
 * @param isPasswordCommon true if the password is in the list of common
 * passwords, else false
 * @param manySeconds true if the password takes 60 seconds or more to crack,
 * else false
 * @param tooManySeconds true if the time taken to crack the password is beyond
 * what C can store, else false
 ...
 * @param seconds The seconds it takes to crack the password. Used if the number
 * is less than 60.
 */
extern void printResult(const char *passStrength, const bool isPasswordCommon,
                        ...
                        const unsigned long long secondsULL,
 ...
 */
extern void printDetails(const char *pass, const int passLength,
                         const int charsetSize, const double passBitStrength,
                         const char *charsetAdvice);
