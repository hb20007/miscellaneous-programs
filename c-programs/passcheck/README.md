...
Determines the strength of a given password. Usage examples follow.
...
It can be cracked in 2 day(s), 21 hour(s), 4 minute(s), and 33 second(s) on a modern processor.
...
It can be cracked in 17 year(s), 9 day(s), 17 hour(s), 32 minute(s), and 13 second(s) on a modern processor.
...
Try making it longer for even more security.
```
