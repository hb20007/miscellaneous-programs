...
/**
 * @brief Shifts a character based on the shift value if it is a letter.
 * Leaves it untouched if not.
...
/**
 * @brief Converts the shift value from a string to a long and
 ...
 */
extern void encryptDecrypt(const char *mode, const char *shiftAmt,
                           const char *message);
...
/**
 * @brief Performs a dictionary attack with a particular word and
 * all possible shift values
